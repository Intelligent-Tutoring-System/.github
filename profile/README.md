...
Frontend: [Frontend Handover Documentation](https://github.com/Intelligent-Tutoring-System/ITS-front#readme)

Backend: [Backend Handover Documentation](https://github.com/Intelligent-Tutoring-System/ITS-services#readme)

Database: [Database Handover Documentation](https://github.com/Intelligent-Tutoring-System/ITS-database#readme)
...
Each repository works on a system that functions differently and plays a different role on the ITS platform, accordingly, each repository has its own git pull request strategy and CI/CD settings that can be referred to in their own subdocuments.
